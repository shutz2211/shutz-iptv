...
def ejecutar_scraper():
    ...
    # Escaneamos las primeras 5 páginas para probar
    for page in range(1, 6):
        url = f"https://cuevana3i.in/peliculas/page/{page}/"
        try:
            ...
            items = soup.select("ul.Posters li, article.item")
            ...
            for item in items:
                ...
                if title_elem and link_elem:
                    ...
                    # Evitamos duplicados guardando por URL
...
# Ruta para activar el scraper desde Chrome
@app.get("/scrape-all")
@app.get("/scrape")
...
# Ruta para ver las películas en la App / Navegador
@app.get("/catalog")
def get_catalog():
